"use strict";
(globalThis["webpackChunkfb_blocks"] = globalThis["webpackChunkfb_blocks"] || []).push([["vendors-node_modules_vidstack_dev_providers_vidstack-vimeo_js"],{
...
class RAFLoop {
  ...
  start() {
    if (!(0,_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(this.#id)) return;
    this.#loop();
  }
  stop() {
    if ((0,_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(this.#id)) window.cancelAnimationFrame(this.#id);
    this.#id = void 0;
  }
  #loop() {
...
/* harmony import */ var _chunks_vidstack_Bpr4fI4n_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../chunks/vidstack-Bpr4fI4n.js */ "./node_modules/vidstack/dev/chunks/vidstack-Bpr4fI4n.js");
/* harmony import */ var _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../chunks/vidstack-BFg1ZqiG.js */ "./node_modules/vidstack/dev/chunks/vidstack-BFg1ZqiG.js");
/* harmony import */ var _chunks_vidstack_BYNmVJLa_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../chunks/vidstack-BYNmVJLa.js */ "./node_modules/vidstack/dev/chunks/vidstack-BYNmVJLa.js");
/* harmony import */ var _chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../chunks/vidstack-Dv_LIPFu.js */ "./node_modules/vidstack/dev/chunks/vidstack-Dv_LIPFu.js");
/* harmony import */ var _chunks_vidstack_qh1N5_f_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../chunks/vidstack-qh1N5_f_.js */ "./node_modules/vidstack/dev/chunks/vidstack-qh1N5_f_.js");
/* harmony import */ var _chunks_vidstack_zG6PIeGg_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../chunks/vidstack-zG6PIeGg.js */ "./node_modules/vidstack/dev/chunks/vidstack-zG6PIeGg.js");
...
/* harmony import */ var _chunks_vidstack_krOAtKMi_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../chunks/vidstack-krOAtKMi.js */ "./node_modules/vidstack/dev/chunks/vidstack-krOAtKMi.js");
...
class VimeoProvider extends _chunks_vidstack_BoAGnlRt_js__WEBPACK_IMPORTED_MODULE_0__.EmbedProvider {
  $$PROVIDER_TYPE = "VIMEO";
  ...
  #pro = (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.signal)(false);
  #hash = null;
  #currentSrc = null;
  #fullscreenActive = false;
  #seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__.TimeRange(0, 0);
  #timeRAF = new _chunks_vidstack_qh1N5_f_js__WEBPACK_IMPORTED_MODULE_3__.RAFLoop(this.#onAnimationFrame.bind(this));
  #currentCue = null;
  #chaptersTrack = null;
  ...
  preconnect() {
    (0,_chunks_vidstack_zG6PIeGg_js__WEBPACK_IMPORTED_MODULE_4__.preconnect)(this.getOrigin());
  }
  setup() {
    super.setup();
    (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.effect)(this.#watchVideoId.bind(this));
    (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.effect)(this.#watchVideoInfo.bind(this));
    (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.effect)(this.#watchPro.bind(this));
  ...
  setVolume(volume) {
    ...
    this.#remote("setMuted", (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.peek)(this.#ctx.$state.muted));
  }
  ...
  async loadSource(src) {
    ...
    const { videoId, hash } = (0,_chunks_vidstack_krOAtKMi_js__WEBPACK_IMPORTED_MODULE_5__.resolveVimeoVideoId)(src.src);
  ...
  #watchVideoInfo() {
    const videoId = this.#videoId();
    if (!videoId) return;
    const promise = (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.deferredPromise)(), abort = new AbortController();
    this.#videoInfoPromise = promise;
    (0,_chunks_vidstack_krOAtKMi_js__WEBPACK_IMPORTED_MODULE_5__.getVimeoVideoInfo)(videoId, abort, this.#hash).then((info) => {
  ...
  #watchPro() {
    ...
    qualities[_chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_6__.ListSymbol.setReadonly](!isPro);
    if (isPro) {
      return (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.listenEvent)(qualities, "change", () => {
  ...
  #onReady(duration, trigger) {
    ...
    this.#seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__.TimeRange(0, duration);
    const detail = {
      buffered: new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__.TimeRange(0, 0),
  ...
  #onMethod(method, data, trigger) {
    switch (method) {
      ...
      case "getCurrentTime":
        ...
        break;
      case "getBuffered":
        if ((0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.isArray)(data) && data.length) {
          this.#onLoadProgress(data[data.length - 1][1], trigger);
        }
        break;
      case "setMuted":
        this.#onVolumeChange((0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.peek)(this.#ctx.$state.volume), data, trigger);
        break;
      // case 'getTextTracks':
  ...
  #onLoadProgress(buffered, trigger) {
    const detail = {
      buffered: new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__.TimeRange(0, buffered),
      seekable: this.#seekableRange
    };
  ...
  #onChaptersChange(chapters) {
    ...
    const track = new _chunks_vidstack_BYNmVJLa_js__WEBPACK_IMPORTED_MODULE_7__.TextTrack({
      kind: "chapters",
      default: true
  ...
  #onQualitiesChange(qualities, trigger) {
    this.#ctx.qualities[_chunks_vidstack_Bpr4fI4n_js__WEBPACK_IMPORTED_MODULE_8__.QualitySymbol.enableAuto] = qualities.some((q) => q.id === "auto") ? () => this.#remote("setQuality", "auto") : void 0;
    for (const quality of qualities) {
      if (quality.id === "auto") continue;
      const height = +quality.id.slice(0, -1);
      if (isNaN(height)) continue;
      this.#ctx.qualities[_chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_6__.ListSymbol.add](
        {
          id: quality.id,
          width: height * (16 / 9),
          height,
  ...
  #onQualityChange({ id } = {}, trigger) {
    ...
    if (isAuto) {
      this.#ctx.qualities[_chunks_vidstack_Bpr4fI4n_js__WEBPACK_IMPORTED_MODULE_8__.QualitySymbol.setAuto](isAuto, trigger);
      this.#ctx.qualities[_chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_6__.ListSymbol.select](void 0, true, trigger);
    } else {
      this.#ctx.qualities[_chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_6__.ListSymbol.select](newQuality ?? void 0, true, trigger);
    }
  }
  #onEvent(event, payload, trigger) {
    switch (event) {
      ...
      case "bufferend":
        ...
        break;
      case "volumechange":
        this.#onVolumeChange(payload.volume, (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_1__.peek)(this.#ctx.$state.muted), trigger);
        break;
      case "durationchange":
        this.#seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__.TimeRange(0, payload.duration);
  ...
  #reset() {
    this.#timeRAF.stop();
    this.#seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_2__.TimeRange(0, 0);
...
//# sourceMappingURL=vendors-node_modules_vidstack_dev_providers_vidstack-vimeo_js.js.map?ver=06c1b2a1d4f6b906545c