"use strict";
(globalThis["webpackChunkfb_blocks"] = globalThis["webpackChunkfb_blocks"] || []).push([["vendors-node_modules_vidstack_dev_providers_vidstack-google-cast_js"],{
...
/* harmony import */ var _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../chunks/vidstack-BFg1ZqiG.js */ "./node_modules/vidstack/dev/chunks/vidstack-BFg1ZqiG.js");
/* harmony import */ var _chunks_vidstack_qh1N5_f_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../chunks/vidstack-qh1N5_f_.js */ "./node_modules/vidstack/dev/chunks/vidstack-qh1N5_f_.js");
/* harmony import */ var _chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../chunks/vidstack-Dv_LIPFu.js */ "./node_modules/vidstack/dev/chunks/vidstack-Dv_LIPFu.js");
/* harmony import */ var _chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../chunks/vidstack-DDwbYVHV.js */ "./node_modules/vidstack/dev/chunks/vidstack-DDwbYVHV.js");
...
class GoogleCastTracksManager {
  ...
  setup() {
    ...
    (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.listenEvent)(this.#ctx.audioTracks, "change", syncRemoteActiveIds);
    (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.listenEvent)(this.#ctx.textTracks, "mode-change", syncRemoteActiveIds);
    (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.effect)(this.#syncLocalTracks.bind(this));
  }
  getLocalTextTracks() {
  ...
  #syncLocalTracks() {
    ...
    for (const localTrack of localTextTracks) {
      ...
      if (!hasRemoteTrack) {
        (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.untrack)(() => this.#onNewLocalTracks?.());
        break;
      }
    }
  }
  syncRemoteTracks(event) {
    ...
    for (const remoteAudioTrack of remoteAudioTracks) {
      ...
      this.#ctx.audioTracks[_chunks_vidstack_Dv_LIPFu_js__WEBPACK_IMPORTED_MODULE_1__.ListSymbol.add](localAudioTrack, event);
    }
  ...
  #editTracksInfo(request) {
    const media = (0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.getCastSessionMedia)();
...
class GoogleCastProvider {
  ...
  scope = (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.createScope)();
  #player;
  #ctx;
  #tracks;
  #currentSrc = null;
  ...
  #currentTime = 0;
  #played = 0;
  #seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__.TimeRange(0, 0);
  #timeRAF = new _chunks_vidstack_qh1N5_f_js__WEBPACK_IMPORTED_MODULE_4__.RAFLoop(this.#onAnimationFrame.bind(this));
  #playerEventHandlers;
  #reloadInfo = null;
  #isIdle = false;
   ...
   */
  get cast() {
    return (0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.getCastContext)();
  }
  /**
   * @see {@link https://developers.google.com/cast/docs/reference/web_sender/cast.framework.CastSession}
   */
  get session() {
    return (0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.getCastSession)();
  }
  /**
   * @see {@link https://developers.google.com/cast/docs/reference/web_sender/chrome.cast.media.Media}
   */
  get media() {
    return (0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.getCastSessionMedia)();
  }
  /**
   * Whether the current Google Cast session belongs to this provider.
   */
  get hasActiveSession() {
    return (0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.hasActiveCastSession)(this.#currentSrc);
  }
  setup() {
  ...
  #attachCastContextEventListeners() {
    (0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.listenCastContextEvent)(
  ...
  #attachCastPlayerEventListeners() {
    ...
    for (const type of (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.keysOf)(handlers)) {
  ...
  async loadSource(src) {
    ...
    if ((0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.hasActiveCastSession)(src)) {
      this.#resumeSession();
      this.#currentSrc = src;
      return;
    }
    ...
    if (errorCode) {
      ...
      this.#ctx.notify("error", Error((0,_chunks_vidstack_DDwbYVHV_js__WEBPACK_IMPORTED_MODULE_2__.getCastErrorMessage)(errorCode)));
      return;
    }
    this.#currentSrc = src;
  }
  ...
  #reset() {
    if (!this.#reloadInfo) {
      this.#played = 0;
      this.#seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__.TimeRange(0, 0);
    }
    this.#timeRAF.stop();
    this.#currentTime = 0;
  ...
  #resumeSession() {
    const resumeSessionEvent = new _chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.DOMEvent("resume-session", { detail: this.session });
  ...
  #onMediaLoadedChange(event) {
    ...
    Promise.resolve().then(() => {
      if (src !== (0,_chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.peek)(this.#ctx.$state.source) || !this.#player.isMediaLoaded) return;
      this.#reset();
      const duration = this.#player.duration;
      this.#seekableRange = new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__.TimeRange(0, duration);
      const detail = {
        provider: this,
        duration,
        buffered: new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__.TimeRange(0, 0),
  ...
  #onProgress(event) {
    const detail = {
      seekable: this.#getSeekableRange(),
      buffered: new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__.TimeRange(0, this.#played)
  ...
  #getSeekableRange() {
    return this.#player.liveSeekableRange ? new _chunks_vidstack_BFg1ZqiG_js__WEBPACK_IMPORTED_MODULE_3__.TimeRange(this.#player.liveSeekableRange.start, this.#player.liveSeekableRange.end) : this.#seekableRange;
  }
  #createEvent(detail) {
    return detail instanceof Event ? detail : new _chunks_vidstack_Bu2kfzUd_js__WEBPACK_IMPORTED_MODULE_0__.DOMEvent(detail.type, { detail });
  }
  #buildMediaInfo(src) {
...
//# sourceMappingURL=vendors-node_modules_vidstack_dev_providers_vidstack-google-cast_js.js.map?ver=150c0826450756b069b1